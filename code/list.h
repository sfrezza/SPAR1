 ...
 * data structures:
 *------------------------------------------------------------------------*/
//##ModelId=3DA5B06D0102
typedef struct list_struct list;
//##ModelId=3DA5B06D0120
typedef struct indexed_list ilist;

//##ModelId=3DA5B06D0148
struct list_struct
{
    int *this;
	//##ModelId=3DA5B06D015E
    list *next;
};

//##ModelId=3DA5B06D0198
struct indexed_list
{
	//##ModelId=3DA5B06D01AC
    int index;
    int *this;
	//##ModelId=3DA5B06D01B7
    ilist *next;
};
